        ...
        <v-row v-if="!status.loggedIn" align="center" justify="end">
          ...
          <v-col v-else align-right>
            <v-btn class="transparent elevation-0" to="/login">
              <v-icon>fa fa-sign-in-alt mr-2</v-icon>Login
            </v-btn>
          </v-col>
        </v-row>
...
import BarraLateral from './../../config/navigation/BarraLateral';

import LogoPng from '@/assets/logos/logo-doafacil-bg-white.png';
